...
describe("UniswapV4Adapter", function () {
  const feeBps = 30n;
  ...
  async function deployFixture() {
    ...
    const UniswapV4Adapter = await ethers.getContractFactory("UniswapV4Adapter");
  ...
  it("pulls input from the caller and sends Uniswap output to the recipient", async function () {
  ...
  it("rejects a route target that is not the Uniswap router or Permit2", async function () {
    ...
    ).to.be.revertedWith("Invalid Uniswap target");
  });
});
